...
public class PredicateExtractor extends ScalarOperatorVisitor<RangePredicate, PredicateExtractor.RangeExtractorContext> {
    ...
    @Override
    public RangePredicate visit(ScalarOperator scalarOperator, RangeExtractorContext context) {
        return null;
    }
            ...
            if (predicate.isOr()) {
                if (childRange instanceof ColumnRangePredicate) {
                    ...
                    Optional<RangePredicate> rangePredicateOptional = rangePredicates.stream().filter(rangePredicate -> {
                        ...
                        return columnRangePredicate.getColumnRef().equals(childColumnRange.getColumnRef());
                    }).findFirst();
                    /*
                    for (RangePredicate rangePredicate : rangePredicates) {
                        if (rangePredicate instanceof ColumnRangePredicate) {
                            ColumnRangePredicate columnRangePredicate = rangePredicate.cast();
                            if (columnRangePredicate.getColumnRef().equals(childColumnRange.getColumnRef())) {
                                found = true;
                                ColumnRangePredicate newPredicate = columnRangePredicate.orRange(columnRangePredicate, childColumnRange);
                                rangePredicates.remove(columnRangePredicate);
                     ...
                     */
                    if (rangePredicateOptional.isPresent()) {
                        ColumnRangePredicate matchedColumnRangePredicate = rangePredicateOptional.get().cast();
                        ColumnRangePredicate newPredicate = matchedColumnRangePredicate.orRange(matchedColumnRangePredicate, childColumnRange);
                ...
                if (childRange instanceof ColumnRangePredicate) {
                        ...
                        if (rangePredicate instanceof ColumnRangePredicate) {
                            ...
                            if (columnRangePredicate.getColumnRef().equals(childColumnRange.getColumnRef())) {
                                ...
                                ColumnRangePredicate newPredicate =
                                        ColumnRangePredicate.andRange(columnRangePredicate, childColumnRange);
                                rangePredicates.remove(rangePredicate);
                                rangePredicates.add(newPredicate);
                            }
                        }
                    }
                    ...
                    if (rangePredicateOptional.isPresent()) {
                        ColumnRangePredicate newPredicate =
                                ColumnRangePredicate.andRange(rangePredicateOptional.get().cast(), childColumnRange);
                        rangePredicates.remove(rangePredicateOptional.get());
                        rangePredicates.add(newPredicate);
                    } else {
                        if (!childColumnRange.isUnbounded()) {
                            rangePredicates.add(childRange);
